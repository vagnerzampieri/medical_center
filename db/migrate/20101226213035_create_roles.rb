...
class CreateRoles < ActiveRecord::Migration
  def self.up
    ...
    Role.create(:id => 4, :name => 'medico', :description => 'Enfermagem tem acesso a Agenda', :enabled => 1)
    Role.create(:id => 5, :name => 'enfermagem', :description => 'Médico tem acesso a Agenda', :enabled => 1)
